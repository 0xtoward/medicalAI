...
![主线 SHAP 图](results/relapse/Hazard_SHAP_Relapse.png)
...
3. `results/relapse/Hazard_Curve_Strict.png`
4. `results/relapse/Calibration_Interval.png`
5. `results/relapse/Patient_Risk_Q1Q4.png`
6. `results/relapse/DCA_Patient.png`
7. `results/relapse/Hazard_SHAP_Relapse.png`
8. `results/relapse/Logistic_Reg_Coefficient_Flow.png`
9. `results/fixed_landmark_binary/ROC_6-Mo.png`
10. `results/recurrent_survival/Model_Comparison_Bar.png`
11. `results/relapse_two_stage_physio/TwoStage_Group_Comparison.png`
