...
- Current static best two-stage reference: `direct_plus_physio_fusion` with PR-AUC `0.350`.
...
## Round 2
- Winner: `c2_interval_slope_windowcal` (c2).
- Metrics: PR-AUC `0.260`, AUC `0.828`, Brier `0.065`.
- Stop-rule hits: `3`.
