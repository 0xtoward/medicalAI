...
- Current champion fused reference: `PR-AUC 0.348`, `AUC 0.850`.
...
- Grouped bootstrap vs current champion: `ΔPR-AUC +0.003` with 95% CI `-0.002` to `+0.009`.
...
- Strongest stop-rule row: `direct_windowed_core` with `Pass_Count=4` and `ΔPR-AUC=-0.002`.
